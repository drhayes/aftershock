local config = {
  ...
  building = {
    ...
    firstFloorDamageFactor = .38, -- During a quake, how much damage to do to the first floor. (i.e. it can't exceed the damageDistanceThreshold so would normally take no damage)
